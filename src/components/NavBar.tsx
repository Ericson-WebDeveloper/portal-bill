...
const NavBar = (props: NavBarProps) => {
  return (
    <div className="w-full flex border-b-2">
      <nav className="bg-white w-full md:w-auto border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          <a href="/" className="flex items-center">
            <img src={Logo} className="h-28 w-36 mr-3" alt="CheckUrBills" />
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li className="w-full">
                <Link to={`/about`}
                  className="block text-lg py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent 
              ...
              <li className="w-full">
                <Link to={`/billers`}
                  className="block text-lg py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 
