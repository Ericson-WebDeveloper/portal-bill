...
//     console.log(event);
//     event.error ? setErrorCard(event.error.message) : setErrorCard(null);
//   };
...
//     // call api post request to confirm payment
//   };

//   return (
//     <form onSubmit={handleSubmit}>
//       {/* <CardElement
//         className={`border-[1px] p-4 rounded-xl ${
//           errorCard ? "border-red-500 text-red-500" : ""
//         }`}
//       /> */}
...
//       </div>
//       <div className="relative z-0 mb-3 w-full group">
//         <label className="">Card Expiry</label>
//         <CardExpiryElement
//           onChange={handleCardDetailsChange}
//           className={`border-[1px] p-4 rounded-xl ${
//             errorCard ? "border-red-500 text-red-500" : ""
...
//       </div>
//       <div className="relative z-0 mb-3 w-full group">
//         <label className="">Card CVC</label>
//         <CardCvcElement
//           onChange={handleCardDetailsChange}
//           className={`border-[1px] p-4 rounded-xl ${
//             errorCard ? "border-red-500 text-red-500" : ""
...
export interface PaymentCardDetailsInterface {
  merchant_ref: string;
...
export interface PaymentConfirmInterface {
  merchant_ref: string;
...
const MasterCardModal = (props: MasterCardModalProps) => {
      ...
      <div className="relative w-full h-full max-w-2xl mx-auto mt-12 md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
            <h3 className="text-xl flex items-center  font-semibold text-gray-900 dark:text-white">
